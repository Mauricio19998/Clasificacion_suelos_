...
# Calcula el Cu y Cc
d60 = porcentaje_pasa[6]  # Tamaño de partícula correspondiente al tamiz No. 40
d10 = porcentaje_pasa[9]  # Tamaño de partícula correspondiente al tamiz No. 200
d30 = porcentaje_pasa[8]  # Tamaño de partícula correspondiente al tamiz No. 60
...
#Seimprime el valor del LL y del IP
print("Valor del limite liquido",round(LL, 2))
print("Valor indice de plasticidad",round(IP, 2))